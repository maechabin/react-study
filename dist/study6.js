...
var map = (0, _immutable.Map)([["key", "value"]]);
...
function getInitialState() {
  return (0, _immutable.Map)([['key1', 'value1'], ['key2', 'value2']]);
}
...
function updateState(value) {
  if (state !== state.update('key1', function () {
    return value;
  })) {
    return state.update('key1', function () {
      return value;
    });
  };
}
...
var state3 = (0, _immutable.Map)([['foo', 'bar']]);
